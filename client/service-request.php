...
if (strlen($_SESSION['clientmsuid']==0)) {
	...
	if(isset($_POST['submit']))
  {
   ...
   $sql="insert into tblservices(client_id,ClientName,CompanyName,Address,City,State,Postcode,Phone,Email,RequestDate,CreateDate,Remark)values(:clientid,:cname,:comname,:address,:city,:state,:postcode,:phone,:email,:requestdate,:createdate,:remark)";
   $query=$dbh->prepare($sql);
   $query->bindParam(':clientid',$cname,PDO::PARAM_STR);
...
<input type="hidden" name="state"  value="<?php  echo $row->State;?>" class="form-control" required='true' readonly> 
